...
type Endpoint3_0Request = Parameters<RawClient["server.architecture"]["architecture.resource.list"]>[0]
type Endpoint3_0Input = { readonly location?: Endpoint3_0Request["query"]["location"] }
const Endpoint3_0 = (raw: RawClient["server.architecture"]) => (input?: Endpoint3_0Input) =>
  raw["architecture.resource.list"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint3_1Request = Parameters<RawClient["server.architecture"]["architecture.resource.create"]>[0]
type Endpoint3_1Input = {
  readonly location?: Endpoint3_1Request["query"]["location"]
  readonly id?: Endpoint3_1Request["payload"]["id"]
  readonly name: Endpoint3_1Request["payload"]["name"]
}
const Endpoint3_1 = (raw: RawClient["server.architecture"]) => (input: Endpoint3_1Input) =>
  raw["architecture.resource.create"]({
    query: { location: input["location"] },
    payload: { id: input["id"], name: input["name"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint3_2Request = Parameters<RawClient["server.architecture"]["architecture.resource.get"]>[0]
type Endpoint3_2Input = {
  readonly resourceID: Endpoint3_2Request["params"]["resourceID"]
  readonly location?: Endpoint3_2Request["query"]["location"]
}
const Endpoint3_2 = (raw: RawClient["server.architecture"]) => (input: Endpoint3_2Input) =>
  raw["architecture.resource.get"]({
    params: { resourceID: input["resourceID"] },
    query: { location: input["location"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint3_3Request = Parameters<RawClient["server.architecture"]["architecture.resource.draft.get"]>[0]
type Endpoint3_3Input = {
  readonly resourceID: Endpoint3_3Request["params"]["resourceID"]
  readonly location?: Endpoint3_3Request["query"]["location"]
}
const Endpoint3_3 = (raw: RawClient["server.architecture"]) => (input: Endpoint3_3Input) =>
  raw["architecture.resource.draft.get"]({
    params: { resourceID: input["resourceID"] },
    query: { location: input["location"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint3_4Request = Parameters<RawClient["server.architecture"]["architecture.resource.draft.patch"]>[0]
type Endpoint3_4Input = {
  ...
  readonly revision: Endpoint3_4Request["payload"]["revision"]
  readonly digest: Endpoint3_4Request["payload"]["digest"]
  readonly operations: Endpoint3_4Request["payload"]["operations"]
}
...
type Endpoint3_5Request = Parameters<RawClient["server.architecture"]["architecture.resource.draft.commit"]>[0]
type Endpoint3_5Input = {
  ...
  readonly revision: Endpoint3_5Request["payload"]["revision"]
  readonly digest: Endpoint3_5Request["payload"]["digest"]
}
...
type Endpoint3_6Request = Parameters<RawClient["server.architecture"]["architecture.resource.draft.discard"]>[0]
...
type Endpoint3_7Request = Parameters<RawClient["server.architecture"]["architecture.resource.draft.reload"]>[0]
...
type Endpoint3_8Request = Parameters<RawClient["server.architecture"]["architecture.resource.remove"]>[0]
type Endpoint3_8Input = {
  ...
  readonly revision: Endpoint3_8Request["payload"]["revision"]
  readonly digest: Endpoint3_8Request["payload"]["digest"]
}
const Endpoint3_8 = (raw: RawClient["server.architecture"]) => (input: Endpoint3_8Input) =>
  raw["architecture.resource.remove"]({
    params: { resourceID: input["resourceID"] },
    query: { location: input["location"] },
    payload: { revision: input["revision"], digest: input["digest"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint3_9Request = Parameters<RawClient["server.architecture"]["architecture.resource.reset"]>[0]
type Endpoint3_9Input = {
  readonly resourceID: Endpoint3_9Request["params"]["resourceID"]
  readonly location?: Endpoint3_9Request["query"]["location"]
}
const Endpoint3_9 = (raw: RawClient["server.architecture"]) => (input: Endpoint3_9Input) =>
  raw["architecture.resource.reset"]({
    params: { resourceID: input["resourceID"] },
    query: { location: input["location"] },
  }).pipe(Effect.mapError(mapClientError))

const adaptGroup3 = (raw: RawClient["server.architecture"]) => ({
  listResources: Endpoint3_0(raw),
  createResource: Endpoint3_1(raw),
  getResource: Endpoint3_2(raw),
  getDraft: Endpoint3_3(raw),
  patchDraft: Endpoint3_4(raw),
  commitDraft: Endpoint3_5(raw),
  discardDraft: Endpoint3_6(raw),
  reloadSaved: Endpoint3_7(raw),
  removeResource: Endpoint3_8(raw),
  resetResource: Endpoint3_9(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  architecture: adaptGroup3(raw["server.architecture"]),
