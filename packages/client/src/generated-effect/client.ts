...
type Endpoint3_3Request = Parameters<RawClient["server.architecture"]["architecture.resource.duplicate"]>[0]
type Endpoint3_3Input = {
  ...
  readonly id?: Endpoint3_3Request["payload"]["id"]
  readonly name?: Endpoint3_3Request["payload"]["name"]
}
const Endpoint3_3 = (raw: RawClient["server.architecture"]) => (input: Endpoint3_3Input) =>
  raw["architecture.resource.duplicate"]({
    params: { resourceID: input["resourceID"] },
    query: { location: input["location"] },
    payload: { id: input["id"], name: input["name"] },
  }).pipe(Effect.mapError(mapClientError))
