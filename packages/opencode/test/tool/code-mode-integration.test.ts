    ...
    Layer.mock(LocationServiceMap.Service, {
      get: () =>
        Layer.mock(ArchitectureGraph.Service, {
          ...
          loadInstance: () => Effect.die("unexpected graph instance load in CodeMode integration test"),
          patchInstance: () => Effect.die("unexpected graph instance patch in CodeMode integration test"),
          commitInstance: () => Effect.die("unexpected graph instance commit in CodeMode integration test"),
          discardInstance: () => Effect.die("unexpected graph instance discard in CodeMode integration test"),
          reloadInstance: () => Effect.die("unexpected graph saved reload in CodeMode integration test"),
          ...
          queryInstances: () => Effect.die("unexpected graph live query in CodeMode integration test"),
          context: () => Effect.die("unexpected graph context in CodeMode integration test"),
          contextInstances: () => Effect.die("unexpected graph live context in CodeMode integration test"),
        }),
    } as any),
  )
  return {
