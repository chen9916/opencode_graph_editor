    ...
    Layer.mock(LocationServiceMap.Service, {
      get: () =>
        Layer.mock(ArchitectureGraph.Service, {
          ...
          discardDraft: () => Effect.die("unexpected graph draft discard in CodeMode integration test"),
          reloadSaved: () => Effect.die("unexpected graph saved reload in CodeMode integration test"),
          ...
          queryLive: () => Effect.die("unexpected graph live query in CodeMode integration test"),
          context: () => Effect.die("unexpected graph context in CodeMode integration test"),
          contextLive: () => Effect.die("unexpected graph live context in CodeMode integration test"),
        }),
    } as any),
  )
  return {
