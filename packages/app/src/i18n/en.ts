...
export const dict = {
  ...
  "session.tab.architecture": "Graph editor",
  "session.panel.reviewFilesArchitecture": "Review, files, and Graph editor",
  ...
  "architecture.panel.title": "Graph editor",
  "architecture.panel.revision": "Revision {{revision}}",
  "architecture.panel.nodes": "Nodes: {{count}}",
  "architecture.panel.edges": "Connections: {{count}}",
  "architecture.panel.loading": "Loading graphs...",
  "architecture.panel.error": "Graphs could not be loaded.",
  "architecture.panel.unsupported": "The Graph editor requires an OpenCode V2 server.",
  "architecture.panel.empty.description": "Create a graph to share an idea with people and AI.",
  "architecture.outline.title": "Graph outline",
  "architecture.inspector.title": "Selection",
  "architecture.panel.properties": "Properties",
  "architecture.field.name": "Name",
  "architecture.field.text": "Text",
  "architecture.field.tags": "Tags",
  "architecture.field.tagHub": "Tag hub",
  "architecture.field.tagColor": "Color",
  "architecture.field.tagUsage": "{{count}} nodes",
  "architecture.field.noTags": "No tags",
  "architecture.field.clearColor": "Clear color",
  "architecture.field.connectionStyle": "Wire style",
  "architecture.field.sourceSide": "Source side",
  "architecture.field.targetSide": "Target side",
  "architecture.side.top": "Top",
  "architecture.side.right": "Right",
  "architecture.side.bottom": "Bottom",
  "architecture.side.left": "Left",
  "architecture.connection.rectangular": "Rectangular",
  "architecture.connection.curved": "Curved",
  "architecture.connection.straight": "Straight",
  "architecture.filter.search": "Search graph",
  "architecture.filter.allTags": "All tags",
  "architecture.filter.clear": "Clear",
  "architecture.action.addNode": "Add node",
  "architecture.node.defaultText": "New node",
  "architecture.action.save": "Save",
  "architecture.action.reload": "Reload",
  "architecture.action.fitView": "Fit view",
  "architecture.action.fitSelection": "Fit selection",
  "architecture.action.undo": "Undo",
  "architecture.action.redo": "Redo",
  "architecture.action.delete": "Delete",
  "architecture.action.duplicate": "Duplicate",
  "architecture.action.exportResource": "Export graph",
  "architecture.action.exportPatch": "Copy pending patch",
  "architecture.action.askSelection": "Ask about selection",
  "architecture.ask.placeholder": "Ask about these selected graph items...",
  "architecture.ask.label": "Ask about selected graph items",
  "architecture.ask.contextAttached": "Graph selection context attached",
  "architecture.conflict.title": "Conflicts requiring review",
  "architecture.conflict.changed": "The target changed externally",
  "architecture.conflict.missing": "The target no longer exists",
  "architecture.conflict.exists": "The ID is already in use",
  "architecture.conflict.explanation": "{{reason}} while applying {{operation}} to {{target}}.",
  "architecture.conflict.target.graph": "the graph",
  "architecture.conflict.target.resource": "graph {{id}}",
  "architecture.conflict.target.tag": "tag {{id}}",
  "architecture.conflict.target.node": "node {{id}}",
  "architecture.conflict.target.edge": "connection {{id}}",
  "architecture.operation.resourceUpdate": "graph rename",
  "architecture.operation.tagColor": "tag color change",
  "architecture.operation.nodeCreate": "node creation",
  "architecture.operation.nodeUpdate": "node update",
  "architecture.operation.nodePosition": "node move",
  "architecture.operation.nodeRemove": "node deletion",
  "architecture.operation.edgeCreate": "connection creation",
  "architecture.operation.edgeUpdate": "connection update",
  "architecture.operation.edgeRemove": "connection deletion",
  "architecture.state.dirty": "Unsaved changes",
  "architecture.state.clean": "Saved",
  "architecture.state.selected": "{{nodes}} nodes, {{edges}} connections selected",
  "architecture.state.moveSelectionHint": "Drag any selected node to reposition the whole selection.",
  "architecture.debug.title": "Sync debug",
  "architecture.debug.resourceID": "Resource ID",
  "architecture.debug.dirty": "Dirty",
  "architecture.debug.dirtyReasons": "Dirty reasons",
  "architecture.debug.syncStatus": "Sync status",
  "architecture.debug.pendingOperations": "Pending operations",
  "architecture.debug.conflicts": "Conflicts",
  "architecture.debug.liveInstance": "Live instance",
  "architecture.debug.savedRevision": "Saved revision",
  "architecture.debug.savedDigest": "Saved digest",
  "architecture.debug.visibleRevision": "Visible revision",
  "architecture.debug.visibleDigest": "Visible digest",
  "architecture.debug.yes": "Yes",
  "architecture.debug.no": "No",
  "architecture.debug.none": "None",
  "architecture.debug.status.unselected": "No graph selected",
  "architecture.debug.status.loading": "Loading graph",
  "architecture.debug.status.clean": "Clean",
  "architecture.debug.status.liveInstance": "Live instance pending save",
  "architecture.debug.status.localPending": "Local operations pending",
  "architecture.debug.status.conflicted": "Conflicts require review",
  "architecture.debug.status.pendingCovered": "Local pending covered by newer snapshot",
  "architecture.debug.reason.pendingOperations": "Pending operations",
  "architecture.debug.reason.pendingConflicts": "Pending conflicts",
  "architecture.debug.reason.liveInstance": "Live instance",
  "architecture.debug.activity": "Recent activity",
  "architecture.debug.noActivity": "No activity yet",
  "architecture.debug.event.journal": "Local journal",
  "architecture.debug.event.sync": "Live sync",
  ...
  "architecture.debug.eventStatus.succeeded": "Succeeded",
  "architecture.debug.eventStatus.failed": "Failed",
  "architecture.debug.eventOperations": "Operations: {{operations}}",
  "architecture.resource.select": "Graph",
  "architecture.resource.none": "No graphs",
  "architecture.resource.new": "New graph",
  "architecture.resource.duplicate": "Duplicate graph",
  "architecture.resource.delete": "Delete graph",
  "architecture.resource.details": "Graph",
  "architecture.resource.defaultName": "Graph {{number}}",
  "architecture.resource.duplicateName": "{{name}} copy",
  "architecture.confirm.discard": "Discard all unsaved changes to this graph?",
  "architecture.confirm.deleteNode": "Delete this node and its connections?",
  "architecture.confirm.deleteEdge": "Delete this connection?",
  "architecture.confirm.deleteSelection": "Delete selected graph items?",
  "architecture.confirm.deleteResource": "Delete this graph?",
  "architecture.toast.copied": "Pending graph patch copied.",
  "architecture.toast.exported": "Graph exported.",
  "architecture.toast.exported.description": "Downloaded {{filename}}.",
  "architecture.toast.exportFailed": "The graph could not be exported.",
  "architecture.toast.saveFailed": "Graph changes could not be saved.",
  "architecture.toast.askSelectionFailed": "The graph selection prompt could not be sent.",
  "architecture.toast.resourceCreateFailed": "The graph could not be created.",
  "architecture.toast.resourceDuplicateFailed": "The graph could not be duplicated.",
  "architecture.toast.resourceDeleteFailed": "The graph could not be deleted.",
  "command.architecture.open": "Open Graph editor",
  "command.architecture.save": "Save Graph",
  "command.architecture.reload": "Reload Graph",
  "command.architecture.fitView": "Fit Graph View",
  "command.architecture.undo": "Undo Graph edit",
  "command.architecture.redo": "Redo Graph edit",
  "command.architecture.delete": "Delete Graph selection",
  "command.architecture.addNode": "Add Graph Node",
  ...
  "settings.shortcuts.group.graphEditor": "Graph editor",
  ...
  "settings.agents.description": "Configure which provider model each agent uses.",
  "settings.agents.section.defaults": "Agent model defaults",
  "settings.agents.row.description": "Choose a dedicated model or inherit the current chat model.",
  "settings.agents.model.default": "Use current chat model",
  "settings.agents.model.select.placeholder": "Select model",
  "settings.agents.model.unavailable": "unavailable",
  "settings.agents.empty": "No agents available for this project.",
  "settings.agents.unsupported": "Agent model settings are unavailable on this server.",
  "settings.agents.mode.primary": "Primary",
  "settings.agents.mode.subagent": "Subagent",
  "settings.agents.mode.all": "All",
  "settings.agents.toast.updated.title": "Agent model updated",
  "settings.agents.toast.updated.description": "{{agent}} will use the selected model for new turns.",
  "settings.agents.toast.updateFailed.title": "Failed to update agent model",
